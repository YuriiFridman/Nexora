...
def upgrade() -> None:
    # Skip this migration if the initial schema is already present (e.g. the
    # database was bootstrapped outside of Alembic).  Without this guard a
    # fresh application restart against an existing database raises a
    # ProgrammingError because PostgreSQL rejects CREATE TABLE on a table that
    # already exists.
    bind = op.get_bind()
