...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("bio", sa.String(256), nullable=True),
    ...
    op.create_index(op.f("ix_guilds_owner_id"), "guilds", ["owner_id"])
    ...
    op.create_table(
        ...
        sa.Column("hoist", sa.Boolean(), nullable=False, server_default=sa.text("false")),
    ...
    op.create_index(op.f("ix_roles_guild_id"), "roles", ["guild_id"])
    ...
    op.create_index(op.f("ix_categories_guild_id"), "categories", ["guild_id"])
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("text", "voice", "dm", "group_dm", "stage", "forum", "announcement", name="channeltype"),
            nullable=False,
        ),
        sa.Column("position", sa.Integer(), nullable=False, server_default="0"),
        ...
        sa.Column("bitrate", sa.Integer(), nullable=False, server_default="64000"),
    ...
    op.create_index(op.f("ix_channel_overwrites_channel_id"), "channel_overwrites", ["channel_id"])
    ...
    op.create_index(op.f("ix_reactions_user_id"), "reactions", ["user_id"])
    ...
    op.create_index(op.f("ix_invites_guild_id"), "invites", ["guild_id"])
    ...
    op.create_table(
        ...
        sa.Column(
            "action_type",
            sa.Enum("kick", "ban", "unban", "mute", "unmute", "warn", "timeout", name="actiontype"),
            nullable=False,
        ),
    ...
    op.create_index(op.f("ix_moderation_actions_guild_id"), "moderation_actions", ["guild_id"])
    ...
    op.create_table(
        ...
        sa.Column("is_deafened", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.ForeignKeyConstraint(["channel_id"], ["channels.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(op.f("ix_voice_sessions_channel_id"), "voice_sessions", ["channel_id"])
    op.create_index(op.f("ix_voice_sessions_user_id"), "voice_sessions", ["user_id"])
    ...
    op.create_index(op.f("ix_friend_requests_sender_id"), "friend_requests", ["sender_id"])
    op.create_index(op.f("ix_friend_requests_receiver_id"), "friend_requests", ["receiver_id"])
    ...
    op.create_index(op.f("ix_webhooks_guild_id"), "webhooks", ["guild_id"])
    op.create_index(op.f("ix_webhooks_channel_id"), "webhooks", ["channel_id"])
    ...
    op.create_table(
        ...
        sa.Column(
            "level",
            sa.Enum("all_messages", "only_mentions", "nothing", "default", name="notificationlevel"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_guild_notification_settings_user_id"), "guild_notification_settings", ["user_id"]
    )
    op.create_index(
        op.f("ix_guild_notification_settings_guild_id"), "guild_notification_settings", ["guild_id"]
    )
    ...
    op.create_index(
        op.f("ix_channel_notification_settings_user_id"), "channel_notification_settings", ["user_id"]
    )
    op.create_index(
        op.f("ix_channel_notification_settings_channel_id"), "channel_notification_settings", ["channel_id"]
    )
...
def downgrade() -> None:
    ...
    op.execute("DROP TYPE IF EXISTS overwritetargettype")
